...
# Fallback only: append() already keeps one row per snapshot_kind.
DEFAULT_PORTAL_SNAPSHOT_DISK_RETENTION_DAYS = 1
DEFAULT_PORTAL_SNAPSHOT_LIVE_RETENTION_DAYS = 1
REPORT_CACHE_TTL_SEC = 15
TRANSFERS_CACHE_TTL_SEC = 120
GROUPS_CACHE_TTL_SEC = 30
SPOT_CACHE_TTL_SEC = 10
DEFAULT_WS_MARKET_INTERVAL_SEC = 10
DEFAULT_WS_PORTFOLIO_INTERVAL_SEC = 30
DEFAULT_WS_HEALTH_INTERVAL_SEC = 60
DEFAULT_TRANSFER_WARM_INTERVAL_SEC = 600
DEFAULT_TRANSFER_WARM_DAYS = 90
DEFAULT_TRANSFER_WARM_LIMIT = 100
