...
COVERED_CALL: dict[str, Any] = {
    ...
    "available": True,
    "status": "available",
    "one_liner_zh": "你已經持有 BTC 或 ETH，再賣出買權，先收下權利金；換來的是上漲空間被賣掉、下跌風險幾乎原封不動。",
    ...
    "beginner_zh": [
        ...
        "買權給買方「用履約價買入標的」的權利。你當賣方，等於答應：若到期時價格夠高，對方可以用履約價買走你的幣。",
        "「掩護」的意思是：你帳戶裡已經有對應的現貨，所以對方來買時你交得出幣。這跟空手賣出買權（裸賣）不同——裸賣在大漲時虧損可以遠大於權利金。Canopy v1 只做掩護性買權，不做裸賣選擇權。",
        "權利金是對方付給你的費用，進你的帳戶後就是你的；它不是本金保護，也不是保證每月都會再收到一筆。",
    ],
    "how_it_works_zh": [
        "先把要當擔保的 BTC 或 ETH 放進你自己的 Deribit 子帳（不是把幣交給 Canopy）。",
        "引擎依風險檔選出要賣出的買權（履約價、到期日）。",
        "成交後你立刻收到權利金；子帳裡的現貨被「罩住」，直到到期、被履約，或系統／你自己平倉。",
        "到期若現貨低於履約價，買權作廢，你留下現貨與已收權利金，之後可以再賣下一張。",
        "到期若現貨高於履約價，買方通常會履約：現貨按履約價賣出，你拿到現金，但拿不到履約價以上的漲幅。",
    ],
    "max_profit": {
        "title_zh": "最大獲利",
        "headline_zh": "大約等於你賣出這張買權收到的權利金（扣掉手續費之後）。",
        "body_zh": (
            "掩護性買權的「選擇權這條腿」賺不到無限。現貨再怎麼漲，超過履約價的漲幅屬於買方。"
            "你能鎖定的上方收益，就是進場時收下的權利金。若你提前買回買權平倉，實際獲利會更少，甚至可能虧這條腿。"
        ),
        "when_zh": "到期時現貨仍低於履約價（買權作廢），或現貨剛好在履約價附近被履約、你已收滿權利金。",
    ...
    "max_loss": {
        ...
        "body_zh": (
            "很多人把買方與賣方搞反：買入買權的人最多虧掉已付權利金；賣出掩護性買權的人不是這樣。"
            "你仍然持有現貨，現貨從 10 萬跌到 1 萬，虧的是現貨市值。收到的權利金只是一個小數。"
            "沒有「最多虧權利金」這件事。樹冠是遮蔭不是屋頂：賣出買權不會幫你停損現貨下跌。"
        ),
        "when_zh": "標的大跌、長期下跌，或你被迫在不好的價格平倉／現貨被履約後又想買回。",
        "not_zh": "最大虧損不是權利金、不是訂閱費、也不是履約價減現價那種「看起來有限」的公式可以概括現貨歸零。",
    },
    "example_zh": {
        "title_zh": "用假數字走一遍（不是預測、不是回測）",
        "setup_zh": "假設你持有 1 BTC，現價 100,000 USD。你賣出履約價 110,000 的買權，收到權利金 1,500 USD（示意）。",
        "paths": [
            {
                "label_zh": "現貨不太漲也不太跌",
                "detail_zh": "到期現貨 105,000。買權沒有價值，你留下 BTC 與 1,500。這筆選擇權的獲利大約就是權利金。現貨本身仍隨市值波動。",
            },
            {
                "label_zh": "現貨大漲，現貨被買走",
                "detail_zh": "到期現貨 130,000。買方會用 110,000 買走你的 BTC。你拿不到 110,000 以上的漲幅。選擇權這條腿的最大獲利仍約等於 1,500；你錯過的是現貨繼續漲的那一段。",
            },
            {
                "label_zh": "現貨大跌",
                "detail_zh": "到期現貨 50,000。買權作廢，但你的 BTC 約虧 50,000。1,500 權利金幾乎沒有幫助。若現貨更接近 0，虧損可以接近整筆現貨。這就是最大虧損。",
            },
        ],
    },
    "risks_zh": [
        "現貨下跌是主風險，權利金不是保險。",
        "上漲時現貨可能被賣掉（被履約），之後若幣價續漲你已不在車上。",
        "提早平倉要付出買回買權的成本，可能把已收權利金吐回去。",
        "流動性差、滑價、手續費會吃掉帳面權利金。",
        ...
        "scenarios": [
            {
                ...
                "spot": 105000,
                "label_zh": "不太漲跌",
                "caption_zh": "買權作廢。你留下 BTC，並多了權利金。",
            },
            {
                "id": "rally",
                "spot": 130000,
            ...
            },
            {
                ...
                "spot": 50000,
                "label_zh": "大跌",
                "caption_zh": "買權作廢，但現貨大虧。1,500 幾乎看不見。",
            },
        ],
    },
}
