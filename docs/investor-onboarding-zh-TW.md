...
![策略子帳 API 權限設定（Account=read、Trade=read_write、Wallet=read_write）](./img/onboarding/10-api-strategy-permissions.png)
...
![Fee 專戶 API 權限（Account=read、Wallet=none、Trade=none）](./img/onboarding/13-api-fee-permissions.png)
